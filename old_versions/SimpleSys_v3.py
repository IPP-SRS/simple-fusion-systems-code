...
def simplesystemcode(print_out=True, **kwargs):
	...
	inputs["SigmaMax"] = 300.0        # Maximum stress on the TF structure, MPa
	...
	design_point = dict(**in_dict, **out_dict)
	return design_point
...
design_point = simplesystemcode(**in_dict)
